 ...
 */
package com.roquito.platform.messaging.protocol.mqtt.proto.messages;
...
public abstract class AbstractMessage {
    ...
    public static final byte CONNACK = 2; // PKMPConnect Acknowledgment
    public static final byte PUBLISH = 3; // PKMPPublish message
    public static final byte PUBACK = 4; // PKMPPublish Acknowledgment
    public static final byte PUBREC = 5; //PKMPPublish Received (assured delivery part 1)
    public static final byte PUBREL = 6; // PKMPPublish Release (assured delivery part 2)
    public static final byte PUBCOMP = 7; //PKMPPublish Complete (assured delivery part 3)
    public static final byte SUBSCRIBE = 8; //Client PKMPSubscribe request
    public static final byte SUBACK = 9; // PKMPSubscribe Acknowledgment
