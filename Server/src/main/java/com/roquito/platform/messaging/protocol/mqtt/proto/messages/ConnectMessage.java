...
/**
 * The attributes Qos, Dup and Retain aren't used for PKMPConnect message
 * 
 * @author andrea
 */
public class ConnectMessage extends AbstractMessage {
    ...
    public String toString() {
        String base = String.format("PKMPConnect [clientID: %s, prot: %s, ver: %02X, clean: %b]", m_clientID, m_protocolName, m_procotolVersion, m_cleanSession);
        if (m_willFlag) {
