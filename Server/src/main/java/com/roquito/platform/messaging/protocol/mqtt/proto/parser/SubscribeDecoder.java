...
import com.roquito.platform.messaging.protocol.mqtt.proto.messages.AbstractMessage.QOSType;
import com.roquito.platform.messaging.protocol.mqtt.proto.messages.SubscribeMessage;
...
class SubscribeDecoder extends DemuxDecoder {
    ...
    void decode(AttributeMap ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        if (message.getQos() != QOSType.LEAST_ONE) {
            throw new CorruptedFrameException("Received PKMPSubscribe message with QoS other than LEAST_ONE, was: " + message.getQos());
        }
