 ...
 */
package com.pubkit.platform.notification.gcm;
...
public final class Constants {
    ...
    /**
     * Missing registration_id. GcmConnection should always add the
     * registration_id to the request.
     */
    public static final String ERROR_MISSING_REGISTRATION = "MissingRegistration";
    
    /**
     * Bad registration_id. GcmConnection should remove this registration_id.
     */
     ...
     * GcmConnection should stop sending messages to this device and delete the
